        ...
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold text-white">LicitAlert</span>
            </div>
            ...
            <div className="hidden lg:block">
              <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20 animate-float">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <span className="text-white/60 text-sm ml-2">Dashboard - LicitAlert</span>
                </div>
      ...
      <section className="py-20 gradient-hero">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8">
            Junte-se a milhares de empresas que já usam o LicitAlert para encontrar as melhores oportunidades.
          </p>
      ...
      <footer className="bg-gray-900 text-gray-400 py-12">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-white font-bold">LicitAlert</span>
              </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li>contato@licitalert.com.br</li>
                <li>(13) 99999-9999</li>
          ...
          <div className="border-t border-gray-800 pt-8 text-center text-sm">
            <p>© 2026 LicitAlert. Todos os direitos reservados. Dados públicos via PNCP.</p>
          </div>
        </div>
      </footer>
    </div>

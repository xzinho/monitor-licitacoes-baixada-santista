          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-6">
              <Link href="/" className="flex items-center gap-2">
                ...
                <span className="font-bold text-gray-900">LicitAlert</span>
              </Link>
            ...
            <div className="flex items-center gap-3">
              ...
              <button onClick={() => { document.cookie = 'licitalert_token=; path=/; expires=Thu, 01 Jan 1970 00:00:00 GMT'; router.push('/') }} className="text-sm text-gray-500 hover:text-gray-700">
                Sair
              </button>
            </div>
          </div>
